...
export async function generateMetadata({ params }) {
  ...
  if (!caseData) {
    return {
      title: 'Кейс не знайдено | TeleBots',
      description: 'Запитаний кейс не знайдено на нашому сайті.'
    };
  }

  // Використовуємо метадані з translations/index.js якщо вони є, інакше fallback на дані з cases.js
  const title = metadata?.title || `${caseData.title} | TeleBots - Розробка ботів та сайтів`;
