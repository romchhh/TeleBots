...
const blogMetadata = {
  ...
  'integrations': {
    ...
    description: 'Дізнайтеся, як інтегрувати Telegram бота з різними сервісами та API для розширення функціональності. Повний гайд по підключенню платіжних систем, CRM та інших інструментів.',
  ...
  'developing': {
    ...
    description: 'Розповідь про процес розробки Telegram ботів, використані технології та методології. Від ідеї до запуску: етапи створення, тестування та оптимізації функціональності бота.',
  ...
  'magnetto': {
    ...
    description: 'Як використовувати чат-ботів для створення ефективних воронок продажів та автоматизації маркетингу. Покрокові стратегії налаштування, сегментації аудиторії та збільшення конверсії.',
  ...
  'e-commerce': {
    ...
    description: 'Як створити та налаштувати ефективний інтернет-магазин в Telegram за допомогою ботів. Повний гайд по налаштуванню каталогу, приймання платежів та організації доставки товарів.',
  ...
  'sites': {
    ...
    description: 'Професійна розробка сайтів з інтеграцією Telegram ботів та сучасними технологіями. Створюємо лендінги, корпоративні сайти та інтернет-магазини з SEO-оптимізацією та адаптивним дизайном.',
  ...
  'feedback': {
    ...
    description: 'Як ефективно збирати та аналізувати відгуки клієнтів за допомогою Telegram ботів. Автоматизація опитувань, збір feedback та покращення якості обслуговування клієнтів.',
  ...
  'how-to-earn-money': {
    ...
    description: 'Різні способи монетизації Telegram ботів та створення пасивного доходу. Практичні стратегії заробітку через підписки, рекламу, продаж товарів та надання платних послуг.',
  ...
  'security-telegram-bots': {
    ...
    description: 'Повний гайд з безпеки Telegram ботів та захисту даних користувачів. Методи шифрування, аутентифікації, захист від атак та найкращі практики розробки безпечних ботів.',
  ...
  'ai-in-bots': {
    ...
    description: 'Як використовувати технології штучного інтелекту для покращення функціональності Telegram ботів. Інтеграція ChatGPT, машинного навчання та NLP для створення розумних асистентів.',
  ...
  'more-leads': {
    ...
    description: 'Практичні поради щодо налаштування Telegram бота для ефективного збору лідів. Стратегії підвищення конверсії, автоматизації маркетингу та збільшення продажів через бот.',
  ...
  'how-to-monetize-telegram-bot': {
    ...
    description: 'Детальний огляд стратегій та методів монетизації Telegram ботів. Практичні способи заробітку через продаж товарів, підписки, рекламу та надання платних послуг через бота.',
  ...
  'parsers_telebots': {
    ...
    description: 'Розробка та використання парсерів для автоматизації збору даних. Створюємо парсери сайтів, моніторинг цін конкурентів, збір інформації та інтеграцію з Telegram ботами.',
  ...
  'perspectives-in-ukraine': {
    ...
    description: 'Аналіз тенденцій та прогнози розвитку ринку Telegram ботів в Україні. Огляд найпопулярніших ніш, перспективи автоматизації бізнесу та майбутнє месенджер-економіки.',
