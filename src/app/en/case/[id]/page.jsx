...
export async function generateMetadata({ params }) {
  ...
  if (!caseData) {
    return {
      title: 'Case Not Found | TeleBots',
      description: 'The requested case was not found on our website.'
    };
  }

  // Use metadata from translations/index.js if available, otherwise fallback to cases.js data
  const title = metadata?.title || `${caseData.title} | TeleBots - Bot & Website Development`;
