...
import { 
  ...
  FaChartLine, FaSearch, FaFileAlt, FaSync, FaRobot, FaCreditCard
} from 'react-icons/fa';
...
{language === 'uk' ? 'Сфери застосування' : language === 'pl' ? 'Obszary zastosowań' : 'Application Areas'}
        ...
        >
          <motion.h2 
            ...
            variants={fadeInUp}
          >
            {language === 'uk' ? 'Наші досягнення в розробці парсерів' : language === 'pl' ? 'Nasze osiągnięcia w tworzeniu parserów' : 'Our Parser Development Achievements'}
          </motion.h2>
          <motion.div 
          ...
          >
            ...
            >
              ...
              <div className="text-gray-600">{language === 'uk' ? 'Парсерів створено' : language === 'pl' ? 'Parserów utworzonych' : 'Parsers Created'}</div>
            </motion.div>
            <motion.div 
              variants={scaleIn}
              className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow"
            >
              ...
              <div className="text-gray-600">{language === 'uk' ? 'Даних оброблено' : language === 'pl' ? 'Danych przetworzonych' : 'Data Processed'}</div>
            </motion.div>
            <motion.div 
              variants={scaleIn}
              className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow"
            >
              ...
              <div className="text-gray-600">{language === 'uk' ? 'Точність даних' : language === 'pl' ? 'Dokładność danych' : 'Data Accuracy'}</div>
            </motion.div>
            <motion.div 
              variants={scaleIn}
              className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow"
